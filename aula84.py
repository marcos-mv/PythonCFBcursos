...
def createPDF():
    try:
        ...
        cnv.drawImage("/home/marcos/Downloads/quirby.jpeg",pointToMilimeter(50),pointToMilimeter(50))
        cnv.circle(pointToMilimeter(50),pointToMilimeter(50),pointToMilimeter(50))
        cnv.drawString(pointToMilimeter(100), pointToMilimeter(100), "Teste de Criação PDF")
        cnv.save()
    except:
